...
export const SIDEBAR_SECTIONS: SidebarSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: "fabric",
        label: "Memory Fabric",
        subtitle: "One unified memory across AI, apps and devices.",
      ...
      },
      {
        ...
        subtitle: "Knowledge that continuously evolves.",
      ...
      },
      {
        ...
        subtitle: "Collaborative memory ecosystem.",
      ...
      },
      {
        ...
        subtitle: "Replay and explore memory evolution.",
        href: "/dashboard/timeline",
        iconKey: "clock",
      },
      {
        id: "permissions",
        label: "Memory Permissions",
        subtitle: "Secure sharing & Digital Twin.",
...
export const MODULE_CARDS: ModuleCard[] = [
  {
    ...
    title: "Memory Fabric",
    description:
      "The unified memory layer connecting every AI, application and knowledge source.",
    iconKey: "network",
    gradient: "from-[#6D5BFF] to-[#8F7DFF]",
    glowColor: "rgba(109, 91, 255, 0.2)",
    href: "/dashboard/fabric",
  ...
  },
  {
    id: "living-intelligence",
    title: "Living Intelligence",
    description: "Continuously transforms memories into evolving intelligence.",
    iconKey: "brain",
    gradient: "from-[#8F7DFF] to-[#B794F4]",
    glowColor: "rgba(143, 125, 255, 0.2)",
    href: "/dashboard/intelligence",
  ...
  },
  {
    id: "memory-exchange",
    title: "Memory Exchange",
    description: "Share, merge and collaborate using living knowledge graphs.",
    iconKey: "share",
    gradient: "from-[#4CC9F0] to-[#6DD5FA]",
    glowColor: "rgba(76, 201, 240, 0.2)",
    href: "/dashboard/exchange",
  ...
  },
  {
    id: "time-machine",
    title: "Memory Time Machine",
    description: "Replay and visualize how memories evolve through time.",
    iconKey: "clock",
    gradient: "from-[#6D5BFF] to-[#4CC9F0]",
    glowColor: "rgba(109, 91, 255, 0.15)",
    href: "/dashboard/timeline",
  ...
  },
  {
    ...
    description: "Secure memory spaces with Digital Twin intelligence.",
    iconKey: "shield",
    gradient: "from-[#B794F4] to-[#6D5BFF]",
    glowColor: "rgba(183, 148, 244, 0.2)",
    href: "/dashboard/permissions",
